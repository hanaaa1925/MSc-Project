...
class testCase1(unittest.TestCase):
    ...
    def test_login(self):
        ...
        encrypt = driver.find_element(By.XPATH, '//*[@id="app"]/div/div[2]/div/div/ul[2]/li[1]/div[1]/p').text
        decrypt = pybase64.b64decode(encrypt.encode())
        time.sleep(1)
        driver.find_element(By.XPATH, '//*[@id="app"]/div/div[2]/div/div/ul[2]/li[1]/div[2]/div[4]/img').click()
        time.sleep(1)
        getdecrpt = driver.find_element(By.XPATH, '//*[@id="app"]/div/div[2]/div/div').text
        self.assertEqual(decrypt, getdecrpt, msg="fail")
